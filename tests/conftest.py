...
tests never touch the real it_support.db. Cohere API-key variables are
emptied so no test can accidentally call the real provider.
"""
...
os.environ["COHERE_API_KEY_PRIMARY"] = ""
os.environ["COHERE_API_KEY_FALLBACK"] = ""
